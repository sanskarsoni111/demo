...
ActiveRecord::Schema.define(version: 2021_02_26_072726) do
  ...
  create_table "leaveapplies", force: :cascade do |t|
    t.string "user_id"
  ...
  create_table "leaveevents", force: :cascade do |t|
  ...
  create_table "leaveinfos", force: :cascade do |t|
    t.string "types"
    t.integer "no_of_days"
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
